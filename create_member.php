		...
		<div class="container-login100">
			<div style="margin: 0px auto; text-align: center;" class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				<nav class="navbar fixed-top justify-content-center navbar-dark bgblack">
					...
					<a style="color: #f6f6f6;" class="nav-link" href="#">建立總部帳號</a>
				...
				<form id="register" class="login100-form" action="php/add_office_member.php" method="POST">
<!-- 					<span class="login100-form-title p-b-55">
 ...
 -->					<div class="wrap-input100 validate-input m-b-16">
				...
				<input type="hidden" id="identification" name="identification" value="總部">
